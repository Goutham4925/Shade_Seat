...
import { ArrowLeft, Settings as SettingsIcon, Info, Compass, Navigation, Sun, Shield } from "lucide-react";
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-8 animate-fade-in-up">
          ...
          <div className="relative inline-flex items-center justify-center mb-6">
            <div className="absolute inset-0 bg-gradient-to-r from-gray-400 to-gray-600 rounded-3xl blur-lg opacity-30 animate-pulse-slow"></div>
            <div className="relative inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-gray-600 to-gray-700 shadow-lg">
        ...
        <Card className="relative overflow-hidden shadow-2xl border-0 bg-white/80 backdrop-blur-sm rounded-3xl p-8 mb-8 animate-slide-up">
          ...
          <div className="relative z-10">
            <div className="space-y-8">
              ...
              <div className="flex items-center justify-between group p-4 rounded-2xl hover:bg-white/50 transition-all duration-300">
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="flex items-center gap-2 p-3 bg-white/50 rounded-xl border border-gray-100">
        ...
        <div className="text-center animate-fade-in-up">
          <div className="inline-flex items-start gap-4 px-6 py-4 bg-gradient-to-r from-blue-50 to-cyan-50/80 backdrop-blur-sm rounded-2xl shadow-lg border border-blue-200/50 max-w-sm">
        ...
        <div className="mt-8 grid grid-cols-2 gap-4 animate-fade-in-up">
          <Button 
            variant="outline" 
            className="rounded-2xl h-12 border-2 border-gray-200 hover:border-gray-300 transition-all"
            onClick={() => navigate('/')}
          >
            🏠 Home
          </Button>
          <Button 
            className="rounded-2xl h-12 bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 transition-all shadow-lg"
